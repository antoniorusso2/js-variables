...
const citySubstring = city.substring(4); //slice metodo alternativo leggermente migliore ed !invece di 4 ci voleva lla variabile city index
console.log(citySubstring); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced = city.replace('York', 'Delhi'); //city substring invede di york
